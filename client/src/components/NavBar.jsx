...
const NavBar = ({activeSection ,setActiveSection}) => {
  ...
  return (
    <div className='w-full md:w-[90%] mx-auto bg-white md:rounded-lg px-6 py-4 flex justify-between items-center'>
        <img className="hidden md:block w-[108px]" src="icons/logo-devlinks-large.svg" alt='log' />
        <img className="block md:hidden" src="icons/logo-devlinks-small.svg" alt='log' />
