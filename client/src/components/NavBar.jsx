  ...
  return (
    <div className='w-full md:w-[90%] mx-auto bg-white md:rounded-lg px-6 py-4 flex justify-between items-center'>
        ...
        <nav className='flex justify-center items-center gap-1 md:gap-3'>
            <button className={`${activeSection === 'links' ? 'text-[#633cff] bg-[#633cff] bg-opacity-10 ':'text-[#737373] hover:bg-[#633cff] hover:bg-opacity-10' } rounded-lg py-2 px-6 font-semibold flex justify-between items-center gap-3`} onClick={() => setActiveSection('links')}>
            <FaLink /> <span className='hidden md:inline'>Links</span>
            </button>
            <button className={`${activeSection === 'profile' ? 'text-[#633cff] bg-[#633cff] bg-opacity-10 ':'text-[#737373] hover:bg-[#633cff] hover:bg-opacity-10' } rounded-lg py-2 px-6 font-semibold  flex justify-between items-center gap-3`} onClick={() => setActiveSection('profile')}>
